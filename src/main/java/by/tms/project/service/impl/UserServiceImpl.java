package by.tms.project.service.impl;

import by.tms.project.dao.impl.DbUserDaoImpl;
import by.tms.project.dao.impl.EntityTransaction;
import by.tms.project.entity.user.Entity;
import by.tms.project.entity.user.User;
import by.tms.project.exception.DaoException;
import by.tms.project.exception.ServiceException;
import by.tms.project.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<? extends Entity> findByParameter(String parameter, String parameterValue, String commandName, HttpServletRequest request) throws ServiceException {
        return null;
    }

    @Override
    public List<? extends Entity> findByParameter(String parameter, String parameterFrom, String parameterTo, String commandName, HttpServletRequest request) throws ServiceException {
        return null;
    }

    @Override
    public Optional<User> findPatientByLogin(String login) throws ServiceException {
        DbUserDaoImpl userDao = DbUserDaoImpl.getInstance();
    ...
    public boolean checkForLogIn(String login, String password) throws ServiceException {
        ...
        DbUserDaoImpl dbUserDao = DbUserDaoImpl.getInstance();
        EntityTransaction transaction = new EntityTransaction();
